...
if (crop =="corn"):
    ...
    if testML=="true":
        data = {
                    ...
                    "ZONE": tz_splitted[1],
                    "FILE":"Test Image",
                    "P_WS_0": round(float(results[0]),5),
                    "P_WS_1": round(float(results[1]),5),
                    "P_WS_2": round(float(results[2]),5),
                    "P_WS_3": round(float(results[3]),5),
                    "P_WS_4": round(float(results[4]),5),
                    "P_WS_5": round(float(results[5]),5),
                    "P_WS":waterStressLevel,
